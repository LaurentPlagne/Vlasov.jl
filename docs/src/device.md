...
are real. Call sites do not change; only the price does. Flattening this into a
uniform "always copy" would cost Apple Silicon a copy of every buffer at every
step, on the very machine the campaigns run on.
